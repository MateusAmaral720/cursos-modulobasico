...
public class Criar {
	...
	public static ItemStack add(Material m, String nome, List<Enchantment> ench, int level) {

		ItemStack item = new ItemStack(m);
		for (Enchantment encanto : ench) {
	...
	public static ItemStack add(Material m, String nome, int quantidade, String[] lore) {
		ItemStack item = new ItemStack(m);
